...
namespace Griffin.Networking.Pipelines
{
    ...
    public class PipelineNetworkService : INetworkService, IDownstreamHandler
    {
        ...
        private IServerClientContext context;
        ...
        public virtual void HandleDownstream(IPipelineHandlerContext context, IPipelineMessage message)
        {
            ...
            if (sendBuffer != null)
            {
                this.context.Send(new BufferSlice(sendBuffer.Buffer, sendBuffer.Offset, sendBuffer.Count), sendBuffer.Count);
                return;
            }
            ...
            if (sendSlice != null)
            {
                this.context.Send(sendSlice.Slice, sendSlice.Length);
                return;
            }
