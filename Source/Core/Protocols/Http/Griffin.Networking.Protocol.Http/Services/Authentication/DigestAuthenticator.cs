...
namespace Griffin.Networking.Protocol.Http.Services.Authentication
{
    ...
    public class DigestAuthenticator : IAuthenticator
    {
        ...
        private readonly ILogger logger = LogManager.GetLogger<DigestAuthenticator>();
        private readonly NonceService nonceService = new NonceService();
        private readonly IRealmRepository realmRepository;
        private readonly IAccountStorage userService;
